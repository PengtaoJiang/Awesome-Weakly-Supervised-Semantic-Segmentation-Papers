...
| ECS-Net: Improving Weakly Supervised Semantic Segmentation by Using Connections Between Class Activation Maps | ICCV | Image | [PDF](https://openaccess.thecvf.com/content/ICCV2021/papers/Sun_ECS-Net_Improving_Weakly_Supervised_Semantic_Segmentation_by_Using_Connections_Between_ICCV_2021_paper.pdf) | CODE |
...
| BBAM: Bounding Box Attribution Map for Weakly Supervised Semantic and Instance Segmentation | CVPR | Box | [PDF](https://arxiv.org/pdf/2103.08907.pdf) | [CODE](https://github.com/jbeomlee93/BBAM) |
...
| Tell me where to look: Guided attention inference network | CVPR | Image |[PDF](https://openaccess.thecvf.com/content_cvpr_2018/papers/Li_Tell_Me_Where_CVPR_2018_paper.pdf)| [CODE](https://github.com/alokwhitewolf/Guided-Attention-Inference-Network) |

## 2017 
| Title | Venue | Supervision | PDF | CODE |
| :-----|:-----:|:---:|:---:|:----:|
|Object Region Mining with Adversarial Erasing: A Simple Classification to Semantic Segmentation Approach | CVPR | Image | [PDF](https://openaccess.thecvf.com/content_cvpr_2017/papers/Wei_Object_Region_Mining_CVPR_2017_paper.pdf) | CODE|
